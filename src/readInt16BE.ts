 ...
 */
export function readInt16BE<T> (func: (value: number) => T): TExtendFunction<T>;
export function readInt16BE<T, U> (func: (value: U) => T, formatter: TFormatter<U>): TExtendFunction<T>;
export function readInt16BE<T, U> (func: (value: number | U) => T, formatter?: TFormatter<U>): TExtendFunction<T> {
